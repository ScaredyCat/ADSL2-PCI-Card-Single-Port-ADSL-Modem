...
/* XXX Divy. TBD */
#define JSW_LED_IN_PROGRESS_DELAY   1
#define JSW_LED_IN_FAILURE_DELAY    2
#define JSW_LED_SUCCESS_DELAY_ON    3
#define JSW_LED_SUCCESS_DELAY_OFF   4
#define JSW_LED_SUCCESS_NUM_BLIPS   3
...
/* XXX Divy. TBD */
#define jswSetLEDPattern(_pattern)
