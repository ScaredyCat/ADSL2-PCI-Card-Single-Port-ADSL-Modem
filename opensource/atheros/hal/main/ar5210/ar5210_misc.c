 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/ar5210/ar5210_misc.c#5 $
 */
#include "opt_ah.h"
 ...
 */
HAL_BOOL
ar5210GetRfKill(struct ath_hal *ah)
{
	return (AH5210(ah)->ah_rfKill != 0);
}
...
ar5210EnableRfKill(struct ath_hal *ah)
{
	 ...
	 */
	val = ar5210GpioGet(ah, 0);
	ar5210Gpio0SetIntr(ah, 0, (val == 0));
}
...
HAL_BOOL
ar5210SetDecompMask(struct ath_hal *ah, u_int16_t keyidx, int en)
{
	/* nothing to do */
        return AH_TRUE;
}
...
void
ar5210SetCoverageClass(struct ath_hal *ah, u_int8_t coverageclass, int now)
{
}
...
void
ar5210ArDisable(struct ath_hal *ah)
{
}

void
ar5210ResetAR(struct ath_hal *ah)
{
}

void
ar5210ArEnable(struct ath_hal *ah)
{
}

void
ar5210GetDescInfo(struct ath_hal *ah, HAL_DESC_INFO *desc_info)
{
