 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/diag/dumpregs.c#4 $
 */
#include "diag.h"
...
extern	void ar5210SetupRegs(struct ath_diag *, int);
extern	void ar5210DumpRegs(FILE *fd, int what);
extern	void ar5211SetupRegs(struct ath_diag *, int);
extern	void ar5211DumpRegs(FILE *fd, int what);
...
main(int argc, char *argv[])
{
	...
	case AR5210_PROD:
	case AR5210_DEFAULT:
		ar5210SetupRegs(&atd, what);
		break;
	case AR5211_DEVID:
	case AR5311_DEVID:
	case AR5211_DEFAULT:
	case AR5211_FPGA11B:
		ar5211SetupRegs(&atd, what);
		break;
	case AR5212_FPGA:
	case AR5212_DEVID:
	...
	case AR5210_PROD:
	case AR5210_DEFAULT:
		ar5210DumpRegs(stdout, what);
		break;
	case AR5211_DEVID:
	case AR5311_DEVID:
	case AR5211_DEFAULT:
	case AR5211_FPGA11B:
		ar5211DumpRegs(stdout, what);
		break;
	case AR5212_FPGA:
	case AR5212_DEVID:
	case AR5212_DEVID_IBM:
