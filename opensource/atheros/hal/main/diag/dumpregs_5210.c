 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/diag/dumpregs_5210.c#1 $
 */
#include "diag.h"
...
void
ar5210SetupRegs(struct ath_diag *atd, int what)
{
	size_t space = 0;
	u_int8_t *cp;
...
void
ar5210DumpRegs(FILE *fd, int what)
{
