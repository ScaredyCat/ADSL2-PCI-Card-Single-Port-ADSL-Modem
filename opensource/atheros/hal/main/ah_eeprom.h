 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/ah_eeprom.h#3 $
 */
...
typedef struct {
    u_int16_t   pChannels[NUM_2_4_EEPROM_CHANNELS_2413];
    u_int16_t   numChannels;
    u_int16_t   xpd_mask;   /* mask of permitted xpd_gains */
    RAW_DATA_PER_CHANNEL_2413 pDataPerChannel[NUM_2_4_EEPROM_CHANNELS_2413];
...
typedef struct {
    ...
    u_int16_t   numChannels;
    u_int16_t   xpd_mask;   /* mask of permitted xpd_gains */
    EEPROM_DATA_PER_CHANNEL_2413 pDataPerChannel[NUM_2_4_EEPROM_CHANNELS_2413];
