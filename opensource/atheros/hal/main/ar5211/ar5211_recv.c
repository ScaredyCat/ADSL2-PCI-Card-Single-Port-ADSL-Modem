 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/ar5211/ar5211_recv.c#1 $
 */
#include "opt_ah.h"
	...
	u_int32_t pa, struct ath_desc *nds)
{
	...
	ds->ds_rxstat.rs_tstamp = MS(ads->ds_status1, AR_RcvTimestamp);
	...
	ds->ds_rxstat.rs_antenna  = MS(ads->ds_status0, AR_RcvAntenna);
