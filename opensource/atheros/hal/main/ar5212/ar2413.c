 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/ar5212/ar2413.c#3 $
 * $File: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/ar5212/ar2413.c $
 * $Author: sathish $
 * $DateTime: 2005/06/29 12:02:43 $
 * $Change: 143032 $
 *
 */
#include "opt_ah.h"
	...
	u_int16_t *rfXpdGain)
{
	...
	ar2413getGainBoundariesAndPdadcsForPowers(ah, chan->channel,
...
ar2413RfAttach(struct ath_hal *ah, HAL_STATUS *status)
{
	...
	HALASSERT(ahp->ah_analogBanks == AH_NULL);
	ahp->ah_analogBanks = ath_hal_malloc(sizeof(AR5212_RF_BANKS_2413));
	if (ahp->ah_analogBanks == AH_NULL) {
