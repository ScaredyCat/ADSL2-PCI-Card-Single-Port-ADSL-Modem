 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/owl_sw_dev/src/linux/madwifi/hal/main/ar5Owl/ar5Owl_misc.c#3 $
 */
#include "opt_ah.h"
...
ar5212GetWirelessModes(struct ath_hal *ah)
{
	...
	if (ahp->ah_Gmode/* && ahp->ah_NGmode*/) {
		mode |= HAL_MODE_11NG;
	}
	if (ahp->ah_Amode/* && ahp->ah_NAmode*/) {
		mode |= HAL_MODE_11NA;
	}
	return mode;
}
	...
	void **result, u_int32_t *resultsize)
{
	...
	case HAL_DIAG_TXCONT:
		ar5212_ContTxMode(ah,args,argsize );
		return AH_TRUE;
	}
 ...
 */
void
ar5212Set11nMac2040(struct ath_hal *ah, HAL_HT_MACMODE mode)
{
}
