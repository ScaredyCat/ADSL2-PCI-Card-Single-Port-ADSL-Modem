...
#endif
#ifdef CONFIG_IWCONFIG
	APPLET_NOUSAGE("iwconfig", iwconfig_main, _BB_DIR_SBIN, _BB_SUID_NEVER)
	APPLET_NOUSAGE("iwpriv", iwpriv_main, _BB_DIR_SBIN, _BB_SUID_NEVER)
#endif
#ifdef CONFIG_KILL
...
#endif
#ifdef CONFIG_UDHCPR
	APPLET(udhcpr, udhcpr_main, _BB_DIR_SBIN, _BB_SUID_NEVER)
#endif
#ifdef CONFIG_UMOUNT
