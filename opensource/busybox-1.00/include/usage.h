...
#define USAGE_IWCONFIG_OPT_A(a) (a)
#define USAGE_IWPRIV_OPT_A(a) (a)
#define iwconfig_trivial_usage \
	USAGE_IWCONFIG_OPT_A("[-a]") " <interface> [<address>]"
#define iwconfig_full_usage \
	"configure a WLAN interface\n\n"

#define iwpriv_trivial_usage \
	USAGE_IWPRIV_OPT_A("[-a]") " <interface> [<address>]"
...
#define udhcpr_trivial_usage \
	""
#define udhcpr_full_usage \
	""
