...
#ifdef IFX_SMALL_FOOTPRINT /* for small footprint the buffer is allocated from heap */
...
//6092601:hsur disable rotatae to fix memory leakage bug
...
#ifdef IFX_SMALL_FOOTPRINT
	if(lfile == NULL){
		lfile = (char *)calloc(MAXPATHLEN,sizeof(char));
	}
#endif
