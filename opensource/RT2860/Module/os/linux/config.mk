...
WFLAGS += -DRT_BIG_ENDIAN -DINF_DANUBE
endif
...
ifeq ($(PLATFORM),INF_DANUBE)
CFLAGS := -D__KERNEL__ -DMODULE -I$(LINUX_SRC)/include -I$(RT28xx_DIR)/include -I/Danube/3.0.5/source/user/ifx/IFXAPIs/include -Wall -Wstrict-prototypes -Wno-trigraphs -fomit-frame-pointer -fno-strict-aliasing -fno-common -G 0 -mno-abicalls -fno-pic -Os -mtune=4kc -march=4kc -mips32 -Wa,--trap -pipe -mlong-calls $(WFLAGS)
export CFLAGS
endif
