/*
 * "$Id: mxml-string.c,v 1.1.1.1 2007-05-30 03:22:40 andyy Exp $"
 *
             ...
             va_list    ap)		/* I - Pointer to additional arguments */
{
  ...
  */
#ifdef LEADFLY
  if ((buffer = npalloc(1 * (bytes + 1))) != NULL)
...
/*
 * End of "$Id: mxml-string.c,v 1.1.1.1 2007-05-30 03:22:40 andyy Exp $".
 */
