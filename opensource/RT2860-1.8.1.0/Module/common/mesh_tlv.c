	...
	IN PUCHAR Addr6)
{
	...
	MeshSeqBuf[2] = (UINT8)((MeshSeq >> 16) & 0x000000ff);
	MeshSeqBuf[1] = (UINT8)((MeshSeq >> 8) & 0x000000ff);
	MeshSeqBuf[0] = (UINT8)(MeshSeq & 0x000000ff);
	MakeOutgoingFrame(	pFrameBuf,		&TempLen,
						1,				&MeshFlag,
						1,				&TTL,
						1,				(UINT8 *)&MeshSeqBuf[0],
						1,				(UINT8 *)&MeshSeqBuf[1],
						1,				(UINT8 *)&MeshSeqBuf[2],
						END_OF_ARGS);
	...
	IN BOOLEAN AcptLink)
{
	...
	MeshCapInfo.word = pAd->MeshTab.MeshCapability.word;
	...
	IN PMESH_PREP_DEPENDENT_ENTRY pPrepDependEntry)
{
	...
	MakeOutgoingFrame(	pFrameBuf,			&TempLen,
						...
						4,					&OrigSeq,
						1,					&DependMPCount,
						(10*DependMPCount),	pPrepDependEntry, 
						END_OF_ARGS);
	...
	OUT PULONG pFrameLen)
{
	...
	HostNameLen = strlen(pAd->MeshTab.HostName);
