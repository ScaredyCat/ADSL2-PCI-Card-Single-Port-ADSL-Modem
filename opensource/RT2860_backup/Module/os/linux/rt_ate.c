...
#ifdef RALINK_28xx_QA// peter : RALINK_2860_QA ==> RALINK_28xx_QA
...
//		pAd->ate.TxDoneCount = pAd->ate.TxCount;//<==============================PETER
...
INT Set_ATE_Read_RF_Proc(
	...
	IN	PUCHAR			arg)
{
	printk(KERN_EMERG "R1 = %lx\n", pAd->LatchRfRegs.R1);
	printk(KERN_EMERG "R2 = %lx\n", pAd->LatchRfRegs.R2);
	printk(KERN_EMERG "R3 = %lx\n", pAd->LatchRfRegs.R3);
	printk(KERN_EMERG "R4 = %lx\n", pAd->LatchRfRegs.R4);
	...
	IN	PUCHAR			arg)
{
	...
	printk(KERN_EMERG "TxPower0=%d\n", pAd->ate.TxPower0);
	printk(KERN_EMERG "TxPower1=%d\n", pAd->ate.TxPower1);
	printk(KERN_EMERG "TxAntennaSel=%d\n", pAd->ate.TxAntennaSel);
	printk(KERN_EMERG "RxAntennaSel=%d\n", pAd->ate.RxAntennaSel);
	printk(KERN_EMERG "BBPCurrentBW=%d\n", pAd->ate.TxWI.BW);
	printk(KERN_EMERG "GI=%d\n", pAd->ate.TxWI.ShortGI);
	printk(KERN_EMERG "MCS=%d\n", pAd->ate.TxWI.MCS);
	printk(KERN_EMERG "TxMode=%d\n", pAd->ate.TxWI.PHYMODE);
	printk(KERN_EMERG "Addr1=%02x:%02x:%02x:%02x:%02x:%02x\n",
		pAd->ate.Addr1[0], pAd->ate.Addr1[1], pAd->ate.Addr1[2], pAd->ate.Addr1[3], pAd->ate.Addr1[4], pAd->ate.Addr1[5]);
	printk(KERN_EMERG "Addr2=%02x:%02x:%02x:%02x:%02x:%02x\n",
		pAd->ate.Addr2[0], pAd->ate.Addr2[1], pAd->ate.Addr2[2], pAd->ate.Addr2[3], pAd->ate.Addr2[4], pAd->ate.Addr2[5]);
	printk(KERN_EMERG "Addr3=%02x:%02x:%02x:%02x:%02x:%02x\n",
		pAd->ate.Addr3[0], pAd->ate.Addr3[1], pAd->ate.Addr3[2], pAd->ate.Addr3[3], pAd->ate.Addr3[4], pAd->ate.Addr3[5]);
	printk(KERN_EMERG "Channel=%d\n", pAd->ate.Channel);
	printk(KERN_EMERG "TxLength=%d\n", pAd->ate.TxLength);
	printk(KERN_EMERG "TxCount=%d\n", pAd->ate.TxCount);
	printk(KERN_EMERG "RFFreqOffset=%d\n", pAd->ate.RFFreqOffset);
...
INT	Set_ATE_Help_Proc(
	...
	IN	PUCHAR			arg)
{
	printk(KERN_EMERG "ATE=ATESTART, ATESTOP, TXCONT, TXCARR, TXFRAME, RXFRAME\n");
	printk(KERN_EMERG "ATEDA\n");
	printk(KERN_EMERG "ATESA\n");
	printk(KERN_EMERG "ATEBSSID\n");
	printk(KERN_EMERG "ATECHANNEL, range:0~14(unless A band !)\n");
	printk(KERN_EMERG "ATETXPOW0, set power level of antenna 1.\n");
	printk(KERN_EMERG "ATETXPOW1, set power level of antenna 2.\n");
	printk(KERN_EMERG "ATETXANT, set TX antenna. 0:all, 1:antenna one, 2:antenna two.\n");
	printk(KERN_EMERG "ATERXANT, set RX antenna.0:all, 1:antenna one, 2:antenna tow, 3:antenna three.\n");
	printk(KERN_EMERG "ATETXFREQOFFSET, set frequency offset, range 0~63\n");
	printk(KERN_EMERG "ATETXBW, set BandWidth, 0:20MHz, 1:40MHz.\n");
	printk(KERN_EMERG "ATETXLEN, set Frame length, range 24~%d\n", (MAX_FRAME_SIZE - 34/* == 2312 */));
	printk(KERN_EMERG "ATETXCNT, set how many frame going to transmit.\n");
	printk(KERN_EMERG "ATETXMCS, set MCS, reference to rate table.\n");
	printk(KERN_EMERG "ATETXMODE, set Mode 0:CCK, 1:OFDM, 2:HT-Mix, 3:GreenField, reference to rate table.\n");
	printk(KERN_EMERG "ATETXGI, set GI interval, 0:Long, 1:Short\n");
	printk(KERN_EMERG "ATERXFER, 0:disable Rx Frame error rate. 1:enable Rx Frame error rate.\n");
	printk(KERN_EMERG "ATERRF, show all RF registers.\n");
	printk(KERN_EMERG "ATEWRF1, set RF1 register.\n");
	printk(KERN_EMERG "ATEWRF2, set RF2 register.\n");
	printk(KERN_EMERG "ATEWRF3, set RF3 register.\n");
	printk(KERN_EMERG "ATEWRF4, set RF4 register.\n");
	printk(KERN_EMERG "ATELDE2P, load EEPROM from .bin file.\n");
	printk(KERN_EMERG "ATESHOW, display all parameters of ATE.\n");
	printk(KERN_EMERG "ATEHELP, online help.\n");
...
VOID ATEAsicSwitchChannel(
    IN PRTMP_ADAPTER pAd) 
{
	UINT32 R3 = DEFAULT_RF_TX_POWER, R4 = 0, R2;
	UINT32 TxPwer = 0, TxPwer2 = 0, Value;
	...
	switch (pAd->RfIcType)
	{
		/* But only 2850 and 2750 support 5GHz band... */
		case RFIC_2820:
		case RFIC_2850:
		case RFIC_2720:
		case RFIC_2750:
	...
	if (Channel <= 14)
	{
		...
		ATE_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R86, (0x37 - GET_LNA_GAIN(pAd)));// PETER : 0x37 ==> 0x44 for multipath issue ?
		ATE_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R82, 0x62);

		// 5GHz band selection PIN, bit1 and bit2 are complement
...
//	ATE_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R66, (0x2E + GET_LNA_GAIN(pAd)));
	...
	if (Channel > 14)
	{
		...
		DBGPRINT(RT_DEBUG_TRACE, ("SwitchChannel#%d(RF=%d, Pwr0=%u, Pwr1=%u, %dT) to , R1=0x%08lx, R2=0x%08lx, R3=0x%08lx, R4=0x%08lx\n",
								  Channel, 
								  pAd->RfIcType, 
								  (R3 & 0x00003e00) >> 10,
								  (R4 & 0x000007c0) >> 7,
	...
	IN PRXWI_STRUC		pRxWI)
{
	...
	pAd->ate.LastSNR0 = (CHAR)(pRxWI->SNR0);// peter : CHAR ==> UCHAR ?
	pAd->ate.LastSNR1 = (CHAR)(pRxWI->SNR1);// peter : CHAR ==> UCHAR ?
...
//		Data[i] = RTMP_EEPROM_READ16(pAd, i*2);
		RT28xx_EEPROM_READ16(pAd, i*2, Data[i]);
		i++;
	}
}
...
//		RTMP_EEPROM_WRITE16(pAd, i*2, Data[i]);
		RT28xx_EEPROM_WRITE16(pAd, i*2, Data[i]);
		i ++;
	}
}
#ifdef RALINK_28xx_QA// peter : RALINK_2860_QA ==> RALINK_28xx_QA
...
/* command id with Cmd Type == 0x0008 */
		...
		case RACFG_CMD_AP_STOP:
			{
            	...
            	{
            		DBGPRINT(RT_DEBUG_TRACE, ("copy_to_user() fail in case RACFG_CMD_AP_STOP\n"));
                    Status = -EFAULT;
            	}
				else
				{
                	DBGPRINT(RT_DEBUG_TRACE, ("RACFG_CMD_AP_STOP is done !\n"));
				}
		...
		case RACFG_CMD_E2PROM_READ16:
			{
				...
				RT28xx_EEPROM_READ16(pAdapter, offset, value);
				value = htons(value);
		...
		case RACFG_CMD_TX_STOP:
			{
            	...
            	if (copy_to_user(wrq->u.data.pointer, pRaCfg, wrq->u.data.length))
            	{
            		DBGPRINT(RT_DEBUG_TRACE, ("copy_to_user() fail in case RACFG_CMD_TX_STOP\n"));
                    Status = -EFAULT;
            	}
				else
				{
                	DBGPRINT(RT_DEBUG_TRACE, ("RACFG_CMD_TX_STOP is done !\n"));
				}
			}
			break;
	...
	IN	PUCHAR			arg)
{
	...
	{
		printk("Offset can not exceed EEPROM_SIZE( = %d)\n", EEPROM_SIZE);	
		return FALSE;
	}
