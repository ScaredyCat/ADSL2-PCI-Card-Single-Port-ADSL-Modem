	...
	OUT APCLI_STATE_MACHINE_FUNC Trans[])
{
	...
	ApCliStateMachineInit(Sm, (APCLI_STATE_MACHINE_FUNC*)Trans, APCLI_MAX_AUTH_STATE, APCLI_MAX_AUTH_MSG, (APCLI_STATE_MACHINE_FUNC)ApCliDrop, APCLI_AUTH_REQ_IDLE, APCLI_AUTH_MACHINE_BASE);

	// the first column
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_REQ_IDLE, APCLI_MT2_MLME_AUTH_REQ, (APCLI_STATE_MACHINE_FUNC)ApCliMlmeAuthReqAction);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_REQ_IDLE, APCLI_MT2_PEER_DEAUTH, (APCLI_STATE_MACHINE_FUNC)ApCliPeerDeauthAction);

	// the second column
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ2, APCLI_MT2_MLME_AUTH_REQ, (APCLI_STATE_MACHINE_FUNC)ApCliInvalidStateWhenAuth);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ2, APCLI_MT2_PEER_AUTH_EVEN, (APCLI_STATE_MACHINE_FUNC)ApCliPeerAuthRspAtSeq2Action);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ2, APCLI_MT2_PEER_DEAUTH, (APCLI_STATE_MACHINE_FUNC)ApCliPeerDeauthAction);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ2, APCLI_MT2_AUTH_TIMEOUT, (APCLI_STATE_MACHINE_FUNC)ApCliAuthTimeoutAction);

	// the third column
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ4, APCLI_MT2_MLME_AUTH_REQ, (APCLI_STATE_MACHINE_FUNC)ApCliInvalidStateWhenAuth);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ4, APCLI_MT2_PEER_AUTH_EVEN, (APCLI_STATE_MACHINE_FUNC)ApCliPeerAuthRspAtSeq4Action);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ2, APCLI_MT2_PEER_DEAUTH, (APCLI_STATE_MACHINE_FUNC)ApCliPeerDeauthAction);
	ApCliStateMachineSetAction(Sm, APCLI_AUTH_WAIT_SEQ4, APCLI_MT2_AUTH_TIMEOUT, (APCLI_STATE_MACHINE_FUNC)ApCliAuthTimeoutAction);
	...
	IN PVOID SystemSpecific3)
{
	...
	ApCliMlmeEnqueue(pAd, APCLI_AUTH_STATE_MACHINE, APCLI_MT2_AUTH_TIMEOUT, 0, NULL, 0);
	MlmeHandler(pAd);
	...
	IN USHORT ifIndex)
{
	...
	if (pAd->ApCfg.ApCliTab[ifIndex].bBlockAssoc == TRUE)
	{
		...
		*pCurrState = APCLI_AUTH_REQ_IDLE;
		...
		ApCliMlmeEnqueue(pAd, APCLI_CTRL_STATE_MACHINE, APCLI_CTRL_AUTH_RSP,
	...
	IN USHORT ifIndex)
{
	...
	*pCurrState = APCLI_AUTH_REQ_IDLE;
	...
	ApCliMlmeEnqueue(pAd, APCLI_CTRL_STATE_MACHINE, APCLI_CTRL_AUTH_REQ_TIMEOUT, 0, NULL, ifIndex);
