...
#define EXTRA_LLCSNAP_ENCAP(_pBufVA, _pExtraLlcSnapEncap)		\
{																\
...
typedef struct _RTMP_RX_RING
{
	...
	ULONG		RxCpuIdx;
	ULONG		RxDmaIdx;
	LONG		RxSwReadIdx; 	// software next read index
...
#define IS_HT_STA(_pMacEntry)	\
	(_pMacEntry->MaxHTPhyMode.field.MODE >= 2)

#define IS_HT_RATE(_pMacEntry)	\
	(_pMacEntry->HTPhyMode.field.MODE >= 2)
...
typedef struct _RTMP_ADAPTER
{
...
#ifdef WIN_NDIS												// NdisReadRegisterXx or NdisWriteRegisterXx
...
#endif
	ULONG               	MACVersion;      	// MAC version. Record rt2860C(0x28600100) or rt2860D (0x28600101)..
	...
	CHAR                    BeaconBuf[512]; // NOTE: BeaconBuf should be 4-byte aligned
...
//=============================================================
// rt2860c emulation-use Parameter 
	ULONG		rtsaccu[30];
	ULONG		ctsaccu[30];
	ULONG		cfendaccu[30];
	ULONG		bacontent[16];
