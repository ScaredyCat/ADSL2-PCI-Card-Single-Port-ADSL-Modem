...
#define RXD_SIZE               	16
#define RXWI_SIZE             	16
// TXWI_SIZE + 802.11 Header Size + AMSDU sub frame header
...
#define MAX_LEN_OF_MAC_TABLE            32 // if MAX_MBSSID_NUM is 8, this value can't be larger than 211
...
// 
// STA's WSC State machine: states, events, total function #
//
...
#define APCLI_MT2_PEER_AUTH_EVEN           1
#define APCLI_MT2_PEER_DEAUTH              2
#define APCLI_MT2_AUTH_TIMEOUT             3
#define APCLI_MAX_AUTH_MSG                 4
...
// Legency Fixed Tx MODE
#define FIXED_TXMODE_NONE	0
...
#define REGION_9_A_BAND                   9       // 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140

#define REGION_MAXIMUM_A_BAND             8 //10
