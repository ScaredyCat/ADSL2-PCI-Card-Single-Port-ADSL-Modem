...
#ifdef BIG_ENDIAN
		*(USHORT *)(&Frame.BaParm) = SWAP16(*(USHORT *)(&Frame.BaParm));
		Frame.TimeOutValue = SWAP16(Frame.TimeOutValue);
		Frame.BaStartSeq.word = SWAP16(Frame.BaStartSeq.word);
#endif
...
#if 0 //def BIG_ENDIAN
		FrameBar.StartingSeq.word = SWAP16(FrameBar.StartingSeq.word);
		*(USHORT *)(&FrameBar.BarControl) = SWAP16(*(USHORT *)(&FrameBar.BarControl));
#endif
...
#ifdef BIG_ENDIAN
		*(USHORT *)(&Frame.DelbaParm) = SWAP16(*(USHORT *)(&Frame.DelbaParm));
		Frame.ReasonCode = SWAP16(Frame.ReasonCode);
#endif
		MakeOutgoingFrame(pOutBuffer,               &FrameLen,
