...
//            INT     WscMode;
            ...
            */
            ...
            WscBuildBeaconIE(pAdapter, pAdapter->ApCfg.MBSSID[pEntry->apidx].WscControl.WscConfStatus, FALSE, WscMode, WSC_CONFIG_METHODS);
            WscBuildProbeRespIE(pAdapter, WSC_MSGTYPE_AP_WLAN_MGR, pAdapter->ApCfg.MBSSID[pEntry->apidx].WscControl.WscConfStatus, FALSE, WscMode, WSC_CONFIG_METHODS);
    ...
    IN  PRTMP_ADAPTER pAd)
{
    ...
    sprintf(WepKeyName_old, "Key%dStr=", pAd->ApCfg.MBSSID[MAIN_MBSSID].DefaultKeyId+1);
#endif // CONFIG_AP_SUPPORT //
                    ...
                    else if (rtstrstr(pTempStr, WepKeyFormatName))
                    {
                        if (pAd->ApCfg.MBSSID[MAIN_MBSSID].WepStatus == Ndis802_11WEPEnabled)                           
                        {
                            ...
                            if ((pAd->ApCfg.MBSSID[MAIN_MBSSID].WscControl.WscProfile.Profile[0].KeyLength == 5) || 
                             ...
                             rtstrstr(pTempStr, WepKeyName_old))
                    {
                        if (pAd->ApCfg.MBSSID[MAIN_MBSSID].WepStatus == Ndis802_11WEPEnabled)                           
                        {
                            ...
                            if (new_format)
                                ...
                                sprintf(pTempStr, "%s", WepKeyName_old);
                            if ((pAd->ApCfg.MBSSID[MAIN_MBSSID].WscControl.WscProfile.Profile[0].KeyLength == 5) || 
                                (pAd->ApCfg.MBSSID[MAIN_MBSSID].WscControl.WscProfile.Profile[0].KeyLength == 13))
                            {
