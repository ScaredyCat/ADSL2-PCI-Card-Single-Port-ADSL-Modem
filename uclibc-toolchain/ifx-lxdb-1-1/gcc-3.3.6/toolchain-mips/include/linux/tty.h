...
#define MAX_NR_CONSOLES 5       /* serial lines start at 16 */
#define MAX_NR_USER_CONSOLES 5  /* must be root to allocate above this */
#else
#define MIN_NR_CONSOLES 1       /* must be at least 1 */
...
#if defined IFX_SMALL_FOOTPRINT && 0
#define NR_PTYS         32      /* ptys/major */
#define NR_LDISCS       16
#warning XXXXXXXXXXX : Using small num of ptys. be careful
#else
