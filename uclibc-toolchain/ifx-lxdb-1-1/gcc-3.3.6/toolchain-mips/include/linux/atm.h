...
/* "protocol value added for OAM cells */
#define ATM_RAW         6
#define ATM_OAM         7
...
#define ATM_CBR		2
#define ATM_VBR		3
#define ATM_VBR_NRT     ATM_VBR		/* for backward compatibility */
#define ATM_ABR		4
#define ATM_ANYCLASS	5		/* compatible with everything */
#define ATM_VBR_RT      6               /* VBR real-time */
#define ATM_UBR_PLUS    7               /* UBR + */
...
struct atm_trafprm {
	...
	int		max_sdu;	/* maximum SDU in bytes */
        ...
        int             scr;            /* sustained rate in cells per second */        int             mbs;            /* maximum burst size (MBS) in cells */
                                                                                
        /*Neeraj  : extra params for rt-vbr*/
