...
/*
 * AES test vectors. /ifxtest
 */
#define DES_ENC_TEST_VECTORS2 2
#define DES_DEC_TEST_VECTORS2 1

static struct cipher_testvec des_enc_tv_template2[] = {
	{
		...
		.ilen	= 8,
		.result	= { 0x8c, 0xa6, 0x4d, 0xe9, 0xc1, 0xb1, 0x23, 0xa7 },
		.rlen	= 8,
	},
	{
		.key	= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
static struct cipher_testvec des_dec_tv_template2[] = {
	{
		.key	= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.klen	= 16,
		.input	= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.ilen	= 16,
		.result	= { 0x14, 0x0f, 0x0f, 0x10, 0x11, 0xb5, 0x22, 0x3d,
 ...
 * AES test vectors. /ifxtest
 */
#define AES_ENC_TEST_VECTORS2 1
#define AES_DEC_TEST_VECTORS2 1

static struct cipher_testvec aes_enc_tv_template2[] = {
	{ 
		.key	= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.klen	= 16,
		.input	= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.ilen	= 16,
		.result	= { 0x66, 0xe9, 0x4b, 0xd4, 0xef, 0x8a, 0x2c, 0x3b,
...
static struct cipher_testvec aes_dec_tv_template2[] = {
	{ 
		.key	= { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.klen	= 16,
