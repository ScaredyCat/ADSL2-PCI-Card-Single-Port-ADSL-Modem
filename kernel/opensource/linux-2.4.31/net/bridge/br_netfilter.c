...
#ifdef CONFIG_IFX_NETFILTER_PROCFS
int brnf_filter_pre_routing_enable = 0;
int brnf_filter_local_in_enable = 0;
int brnf_filter_forward_enable = 0;
int brnf_filter_local_out_enable = 0;
int brnf_filter_post_routing_enable = 0;
#endif
...
/* 608212:linmars start */
#ifdef CONFIG_IFX_NETFILTER_PROCFS
	{
		.ctl_name	= NET_BRIDGE_NF_PRE_ROUTING_ENABLE,
	...
	{
		.ctl_name	= NET_BRIDGE_NF_LOCAL_IN_ENABLE,
	...
	{
		.ctl_name	= NET_BRIDGE_NF_FORWARD_ENABLE,
	...
	{
		.ctl_name	= NET_BRIDGE_NF_LOCAL_OUT_ENABLE,
	...
	{
		.ctl_name	= NET_BRIDGE_NF_POST_ROUTING_ENABLE,
