...
//507141:tc.chen start
        {NET_NETFILTER_PREROUTING_ENABLE, "netfilter_prerouting_enable",
         &sysctl_netfilter_prerouting_enable, sizeof(int), 0644, NULL,
         &proc_dointvec},
        {NET_NETFILTER_POSTROUTING_ENABLE, "netfilter_postrouting_enable",
         &sysctl_netfilter_postrouting_enable, sizeof(int), 0644, NULL,
         &proc_dointvec},
        {NET_NETFILTER_INPUT_ENABLE, "netfilter_input_enable",
         &sysctl_netfilter_input_enable, sizeof(int), 0644, NULL,
         &proc_dointvec},
        {NET_NETFILTER_OUTPUT_ENABLE, "netfilter_output_enable",
         &sysctl_netfilter_output_enable, sizeof(int), 0644, NULL,
         &proc_dointvec},
        {NET_NETFILTER_FORWARD_ENABLE, "netfilter_forward_enable",
         &sysctl_netfilter_forward_enable, sizeof(int), 0644, NULL,
         &proc_dointvec},
//507141:tc.chen end
#endif
	{0}
