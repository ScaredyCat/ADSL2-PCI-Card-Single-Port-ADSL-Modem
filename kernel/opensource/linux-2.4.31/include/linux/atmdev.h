...
#if defined(CONFIG_IFX_ATM_OAM) || defined(CONFIG_IFX_ATM_OAM_MODULE)
	#define IFX_OAM_SUPPORT_FLAG		1
#else
	#define IFX_OAM_SUPPORT_FLAG		0
#endif
...
typedef void (* ifx_def_pfn_oam)(void *cell);
