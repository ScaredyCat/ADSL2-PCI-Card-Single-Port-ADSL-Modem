...
#ifdef CONFIG_IFX_NETFILTER_PROCFS
        NET_NETFILTER_PREROUTING_ENABLE=109,
        NET_NETFILTER_POSTROUTING_ENABLE=110,
        NET_NETFILTER_INPUT_ENABLE=111,
        NET_NETFILTER_FORWARD_ENABLE=112,
        NET_NETFILTER_OUTPUT_ENABLE=113,
#endif
};
...
/* 608212:linamrs start */
#ifdef CONFIG_IFX_NETFILTER_PROCFS
	NET_BRIDGE_NF_PRE_ROUTING_ENABLE=5,
	NET_BRIDGE_NF_LOCAL_IN_ENABLE=6,
	NET_BRIDGE_NF_FORWARD_ENABLE=7,
	NET_BRIDGE_NF_LOCAL_OUT_ENABLE=8,
	NET_BRIDGE_NF_POST_ROUTING_ENABLE=9,
#endif
/* 608212:linamrs end */
};
