/******************************************************************************
**
** FILE NAME    : danube_led.c
** PROJECT      : Danube
** MODULES     	: LED
**
** DATE         : 22 JUL 2005
** AUTHOR       : Xu Liang
** DESCRIPTION  : LED Controller Driver
...
** 28 AUG 2006  Xu Liang        Fix one bug in function "set_blink_in_batch".
**  2 OCT 2006  Xu Liang        Enable USB on OUT11 (LED 5).
