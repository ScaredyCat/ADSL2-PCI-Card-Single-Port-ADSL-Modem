...
//#endif
	...
	// used when HCD_NONPCI flag is set (see driver->flags)
	unsigned long iomem_start, iomem_len;
...
#define HCD_NONPCI	0x0100		/* HC is not connected through PCI  */	
...
extern int usb_hcd_probe (const struct hc_driver* driver, 
		int irq, unsigned long resource, unsigned long len);

extern void usb_hcd_remove (struct usb_hcd	*hcd);
