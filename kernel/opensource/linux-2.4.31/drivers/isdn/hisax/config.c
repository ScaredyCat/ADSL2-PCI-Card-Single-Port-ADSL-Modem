...
const char *CardType[] = {
	...
	"Hotplug", "Formula-n enter:now PCI a/b", "PEB3086", 
};
...
//HANK2007/1/4 02:57下午
#ifdef CONFIG_HISAX_PEB3086
#undef DEFAULT_CARD
#undef DEFAULT_CFG
#define DEFAULT_CARD ISDN_CTYPE_PEB3086
#define DEFAULT_CFG {0,0x0,0,0}
#endif
...
//HANK2007/1/4 02:58下午
#if CARD_PEB3086
extern int setup_peb3086(struct IsdnCard *card);
#endif
...
static int __devinit checkcard(int cardnr, char *id, int *busy_flag)
{
	...
	case ISDN_CTYPE_GAZEL:
		...
		break;
#endif
//HANK2007/1/4 02:59下午
#if CARD_PEB3086
	case ISDN_CTYPE_PEB3086:
		ret = setup_peb3086(card);
		break;
#endif
#if CARD_W6692
